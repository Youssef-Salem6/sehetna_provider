...
import 'package:sehetna_provider/fetures/profile/manager/profileImage/update_profile_image_cubit.dart';
import 'package:sehetna_provider/fetures/profile/view/widgets/profile_body_view.dart';
            ...
            child: ListView(
              children: [
                ...
                Row(
                  ...
                  children: [
                    BlocConsumer<UpdateProfileImageCubit,
                      ...
                      builder: (context, state) {
                        return Column(
                          children: [
                            ...
                            const SizedBox(
                                height: 12), // Space for the plus icon
                            CustomTxt(
                              txt:
