...
import 'package:sehetna_provider/fetures/auth/view/widgets/loading_view.dart';
...
class _RegisterDocumentsViewState extends State<RegisterDocumentsView> {
  ...
  void initState() {
    ...
    BlocProvider.of<RequiredDocumentsCubit>(context)
        .getRequirdesDocs(email: widget.email)
        .then((_) {
  ...
  void uploadFiles() {
    ...
    // Call the upload API
    BlocProvider.of<UploadDocumentsCubit>(context)
          ...
          listener: (context, state) {
            if (state is UploadDocumentsSuccess) {
              ...
              Navigator.pushAndRemoveUntil(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      DocumentsStatusView(email: widget.email),
                ),
                (route) => false,
              );
