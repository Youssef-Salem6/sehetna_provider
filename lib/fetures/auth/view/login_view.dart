...
import 'package:sehetna_provider/core/authPassField.dart';
import 'package:sehetna_provider/core/authTextField.dart';
import 'package:sehetna_provider/core/custom_icon.dart';
import 'package:sehetna_provider/core/custom_text.dart';
import 'package:sehetna_provider/core/nav_view.dart';
import 'package:sehetna_provider/fetures/auth/manager/login/login_cubit.dart';
import 'package:sehetna_provider/fetures/auth/view/documents_status_view.dart';
import 'package:sehetna_provider/fetures/auth/view/forget_password_view.dart';
import 'package:sehetna_provider/fetures/auth/view/register_documents_view.dart';
import 'package:sehetna_provider/fetures/auth/view/register_view.dart';
        ...
        listener: (context, state) {
          if (state is LoginSuccess) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
                content: Text("Login Failed pls try again"),
              ),
            );
