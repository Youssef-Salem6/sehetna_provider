...
import 'package:sehetna_provider/fetures/home/view/create_complaint_view.dart';
import 'package:sehetna_provider/fetures/home/view/request_services_view.dart';
...
import 'package:sehetna_provider/fetures/home/models/requestDetailsModel.dart';
import 'package:sehetna_provider/fetures/home/view/widgets/Request_details_row.dart';
                ...
                Column(
                  children: [
                    RequestDetailsRow(
                      ...
                      value: DateFormat('MMMM d, h:mm a')
                    ...
                    GestureDetector(
                      onTap: () {
                        if (request.services!.length > 1) {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => RequestServicesView(
                      ...
                      child: RequestDetailsRow(
                        ...
                        value: request.services!.length == 1
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => CreateComplaintView(
